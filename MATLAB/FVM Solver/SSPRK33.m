function [niter,vertices,edges,cells] = ...
        SSPRK33(t0,T,finalT,niter,vertices,edges,cells,courant_number,L,bc,flux)
...
% La simulazione avviene nell'intervallo di tempo [t0,T].
    ...
    while t < T
        ...
        U1 = cells.u;
        [vertices,edges,cells,LU1,dt] = L(vertices,edges,cells,bc,flux,t);
        if niter < 10
        ...
        U2 = U1 + dt*LU1;
        cells.u = U2;
        [vertices,edges,cells,LU2,~] = L(vertices,edges,cells,bc,flux,t+dt);
        
        % Terzo e ultimo stadio
        U3 = (3/4)*U1 + (1/4)*U2 + (dt/4)*LU2;
        cells.u = U3;
        [vertices,edges,cells,LU3,~] = L(vertices,edges,cells,bc,flux,t+dt/2);
